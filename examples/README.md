...
| **[Dense Mesh](dense_mesh.rs)** | A stress test that spawns a number of nodes and fully connects them all, flooding the network. Demonstrates OS resource management. | Stress Testing, Resource Limits, Backpressure |
